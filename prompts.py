...
ANALYZER_SYSTEM_PROMPT = """You are an AI agent that analyzes the CSV provided by the user. The focus of your analysis should be on what the data is, how it is formatted, what each column stands for, and how new data should look like, based on the patterns you've identified"""
...
Use the same exact formatting as the original data. Output only the generated rows, no extra text.
